...
{
    public class DuckBoardItem : BoardItem
    {
        public override async Task CollectBoardItem(Transform targetGoalTransform, Action<BoardItem> onCollected, Action<BoardItem> playCollectSfx)
        {
            ...
            await MoveDuckToTarget(gameManager.GetTargetTransform(BoardItemType.Duck), gameManager.OnBoardItemCollected, gameManager.PlayBoardItemCollectedSound);
        }

        private async Task MoveDuckToTarget(Transform targetGoalTransform, Action<BoardItem> onCollected, Action<BoardItem> playCollectSfx)
        {
